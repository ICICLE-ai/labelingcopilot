...
from model import DETICModel

_model: DETICModel | None = None
_status = "loading"
...
async def health():
    ...
    return HealthResponse(status=_status, model_name="DETIC", gpu_device=f"cuda:{device}" if device != "cpu" else "cpu")
